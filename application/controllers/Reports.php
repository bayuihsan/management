            ...
            ?>  <table class="table table-bordered hoverTable">
                    ...
                    ?> 
                        ...
                        <tr>
                            ...
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persensatu = ($sukses_satu/$tsatu)*100; echo number_format($persensatu)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persendua = ($sukses_dua/$tdua)*100; echo number_format($persendua)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentiga = ($sukses_tiga/$ttiga)*100; echo number_format($persentiga)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenempat = ($sukses_empat/$tempat)*100; echo number_format($persenempat)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenlima = ($sukses_lima/$tlima)*100; echo number_format($persenlima)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenenam = ($sukses_enam/$tenam)*100; echo number_format($persenenam)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentujuh = ($sukses_tujuh/$ttujuh)*100; echo number_format($persentujuh)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persendelapan = ($sukses_delapan/$tdelapan)*100; echo number_format($persendelapan)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persensembilan = ($sukses_sembilan/$tsembilan)*100; echo number_format($persensembilan)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persensepuluh = ($sukses_sepuluh/$tsepuluh)*100; echo number_format($persensepuluh)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persensebelas = ($sukses_sebelas/$tsebelas)*100; echo number_format($persensebelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduabelas = ($sukses_duabelas/$tduabelas)*100; echo number_format($persenduabelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentigabelas = ($sukses_tigabelas/$ttigabelas)*100; echo number_format($persentigabelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenempatbelas = ($sukses_empatbelas/$tempatbelas)*100; echo number_format($persenempatbelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenlimabelas = ($sukses_limabelas/$tlimabelas)*100; echo number_format($persenlimabelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenenambelas = ($sukses_enambelas/$tenambelas)*100; echo number_format($persenenambelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentujuhbelas = ($sukses_tujuhbelas/$ttujuhbelas)*100; echo number_format($persentujuhbelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persendelapanbelas = ($sukses_delapanbelas/$tdelapanbelas)*100; echo number_format($persendelapanbelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persensembilanbelas = ($sukses_sembilanbelas/$tsembilanbelas)*100; echo number_format($persensembilanbelas)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduapuluh = ($sukses_duapuluh/$tduapuluh)*100; echo number_format($persenduapuluh)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduasatu = ($sukses_duasatu/$tduasatu)*100; echo number_format($persenduasatu)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduadua = ($sukses_duadua/$tduadua)*100; echo number_format($persenduadua)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduatiga = ($sukses_duatiga/$tduatiga)*100; echo number_format($persenduatiga)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduaempat = ($sukses_duaempat/$tduaempat)*100; echo number_format($persenduaempat)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persendualima = ($sukses_dualima/$tdualima)*100; echo number_format($persendualima)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduaenam = ($sukses_duaenam/$tduaenam)*100; echo number_format($persenduaenam)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduatujuh = ($sukses_duatujuh/$tduatujuh)*100; echo number_format($persenduatujuh)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduadelapan = ($sukses_duadelapan/$tduadelapan)*100; echo number_format($persenduadelapan)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persenduasembilan = ($sukses_duasembilan/$tduasembilan)*100; echo number_format($persenduasembilan)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentigapuluh = ($sukses_tigapuluh/$ttigapuluh)*100; echo number_format($persentigapuluh)." %";?></b></td>
                            <td style="background-color: whitesmoke;" class="text-right"><b><?php $persentigasatu = ($sukses_tigasatu/$ttigasatu)*100; echo number_format($persentigasatu)." %";?></b></td>
                            <?php $persentotal = ($tsukses/$ttotal)*100; ?>
