...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Sales New Deactivation 2018 <div class="add-button">
    ...
    <div class="panel-body">
        <table id="repeat-cm_ekstrak-table" class="display responsive nowrap" cellspacing="0" width="100%">
            <thead>    
                <th>NO</th><th>MSISDN</th><th>NAME</th><th>LAST DATE MODIFICATION</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo strtoupper($new->last_date_modification) ?></td>
