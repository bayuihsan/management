    ...
    <div class="panel-body">
        <table id="repeat-branch-table" class="display responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <td><?php echo $new->ketua ?></td>
                <td><?php echo $new->status ?></td>
                <td><?php echo $new->update_by ?></td>
                ...
                <a class="mybtn btn-danger btn-xs branch-remove-btn" data-toggle="tooltip" title="Click For Delete" href="<?php echo site_url('branch/add/remove/'.$new->branch_id) ?>">Remove</a></td>
                </tr>
               <?php } ?>
            </tbody>       
