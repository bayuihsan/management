...
<!--Start Panel-->
  <div class="panel panel-default">
    ...
    <div class="panel-body add-client">
      ...
      <div class="form-group"> 
        <label for="sbranch">Change BAST?</label>  *abaikan jikan tidak diubah
        <select name="sno_bast1" class="form-control" id="sno_bast1">  
          <option value="">Ubah BAST</option>
          <?php foreach ($bast as $new) { ?>
            <option value="<?php echo $new->no_bast ?>"><?php echo strtoupper($new->no_bast) ?></option>
            <?php }
            ?>
      ...
      <div class="form-group"> 
          ...
          <div class='input-group date' >
              <input type="text" class="form-control" placeholder="Tanggal Masuk" name="stanggal_masuk" id="stanggal_masuk" value="<?php echo $edit_sales->tanggal_masuk?>"/>   
      ...
      <div class="form-group"> 
          ...
          <div class='input-group date' >
              <input type="text" class="form-control" placeholder="Tanggal Aktivasi" name="stanggal_aktif" id="stanggal_aktif" value="<?php echo $edit_sales->tanggal_aktif?>"/>   
              <span class="input-group-addon">
                  <span class="glyphicon glyphicon-calendar"></span>
              </span>
          </div>
...
<!--Start Panel-->
  <div class="panel panel-default">
    ...
    <div class="panel-body add-client">
      ...
      <div class="form-group"> 
        <label for="sbranch">Change MSISDN?</label> 
