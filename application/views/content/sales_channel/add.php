...
<div class="panel panel-default">
    ...
    <form id="add-sales_channel">
      ...
      <a href="<?php echo base_url()?>Admin/saleschannel_view" class="mybtn btn-warning kembali"><i class="fa fa-backward"></i> Back</a>
    </form>
    <?php }else{ ?>
...
$(document).ready(function(){
  ...
  $('#add-sales_channel').on('submit',function(){     
    $.ajax({
      method : "POST",
      url : "<?php echo site_url('Admin/saleschannel_add/insert') ?>",
      data : $(this).serialize(),
      beforeSend : function(){
      ...
      if(data=="true"){  
        ...
        setTimeout(function(){ document.location.href = '<?php echo base_url()?>Admin/saleschannel_view'; }, 2000);
      }else{
        failedAlert2(data);
        $(".block-ui").css('display','none');
      }   
