...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="col-md-12 col-lg-12 col-sm-12 report-params">
            <form id="sales_cari" action="<?php echo site_url('Admin/reports_sub_channel/view') ?>">
        ...
        <a class="mybtn btn-default export-btn" style="float: right" href="<?php echo site_url('Admin/reports_sub_channel') ?>" >Export to Excel</a>
        </div>
