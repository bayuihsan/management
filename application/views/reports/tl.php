...
<div class="panel panel-default">
    ...
    <div class="panel-heading">TL</div>
    <div class="panel-body">
        <div class="col-md-12 col-lg-12 col-sm-12 report-params">
            <form id="sales_cari" action="<?php echo site_url('Admin/reports_tl/view') ?>">
        ...
        <a class="mybtn btn-default export-btn" style="float: right" href="<?php echo site_url('Admin/reports_tl') ?>" >Export to Excel</a>
        </div>
            ...
            <div id="Table-div">
                <table class="table table-bordered hoverTable">
                    <thead>
                        ...
                        <th style='background-color: black; color: white;'>Nama TL</th>
